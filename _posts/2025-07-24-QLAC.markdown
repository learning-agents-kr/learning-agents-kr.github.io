---
layout: post
title: "[논문 리뷰] Sample-Efficient Reinforcement Learning with Action Chunking"
...
**링크:** [https://arxiv.org/abs/2507.07969](https://arxiv.org/abs/2507.07969)
...
- **Solution: Action chunking**
    ...
    ![$h=5$ 예시.]({{site.baseurl}}/assets/img/250724/image.png)
    
    <center>$h=5$ 예시.</center>
...
- 최근 imitation learning (IL) 분야에서 action chunking을 사용한 연구 등장 (ALOHA 논문; [[2]](#ref2))
...
<summary><p style="display:inline-block; padding-left:2px;">이 decision process를 기존 Markov decision process (MDP)로부터 다시 formulation 가능</p></summary>
...
<a name="ref1"></a> [1] Park, Seohong, Qiyang Li, and Sergey Levine. "Flow q-learning." *arXiv preprint arXiv:2502.02538* (2025).

<a name="ref2"></a> [2] Zhao, Tony Z., et al. "Learning fine-grained bimanual manipulation with low-cost hardware." *arXiv preprint arXiv:2304.13705* (2023). [https://tonyzhaozh.github.io/aloha/](https://tonyzhaozh.github.io/aloha/)
